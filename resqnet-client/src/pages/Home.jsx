...
>
      <div className="flex flex-col gap-6 p-20 px-4 max-w-6xl mx-auto bg-gray-200">
        <h1 className="text-gray-900 font-bold text-3xl lg:text-6xl font-serif">
          Discover ResQNet for your next critical
          disaster management solution
        </h1>
        <div className="text-gray-600 text-xs sm:text-sm">
          ResQNet, your reliable partner in disaster management, where every
